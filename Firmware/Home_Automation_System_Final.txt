 ...
 * 
 * Hardware used: ESP32, DHT11, LDR, PZEM004Tv3, Eletromechanical Relay.
 * Libraries used: PZEM004Tv3, DHT11, WiFi, PubSubClient.
 */
...
float voltage = 0.0;        ///< Variable for voltage reading from PZEM004Tv3
float current = 0.0;        ///< Variable for current reading from PZEM004Tv3
float power = 0.0;          ///< Variable for power reading from PZEM004Tv3
float energy = 0.0;         ///< Variable for energy reading from PZEM004Tv3
float frequency = 0.0;      ///< Variable for frequency reading from PZEM004Tv3
float pf = 0.0;             ///< Variable for power factor reading from PZEM004Tv3

DHT11 dht11(DHTPIN);        ///< Object for the DHT11 sensor
PZEM004Tv30 pzem(Serial1, 16, 17); ///< Object for the PZEM004Tv3 power monitor

const char* ssid = "e=mc2";                         ///< Wi-Fi network SSID
const char* password = "1xperiencia";               ///< Wi-Fi network password
const char* mqtt_server = "192.168.7.112";          ///< MQTT broker IP address

WiFiClient espClient;                               ///< Client for Wi-Fi connection
PubSubClient client(espClient);                     ///< MQTT client

unsigned long currentMillis, previousMillis = 0;     ///< Timing variables
const long interval = 1000;                         ///< Interval for sending data via MQTT
/**
